/**
 * This class represents a Maximum segment tree extends from SegmentTreeByArray
...
public class MaximumSegmentTreeByArray extends SegmentTreeByArray
{
     ...
     */
    public  MaximumSegmentTreeByArray(int[] arr) { super(arr); }
     ...
     * @return the bigger value between both.
     */
    public int Calculation(int left_son, int right_son)
    {
        return Math.max(left_son,right_son);
    }

    /**
     * Queries the Segment Tree for the Maximun value in the given range.
